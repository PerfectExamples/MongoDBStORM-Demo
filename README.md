...
This project is a simple demonstration of using a subset of the MongoDB-StORM functions.
...
```
git clone https://github.com/PerfectExamples/MongoDBStORM-Demo.git
cd MongoDBStORM-Demo
swift build
.build/debug/MongoDBStORM-Demo
```
